    ...
    <main>
        <div class="container-fluid px-4">
            ...
            <div class="row" style="padding-bottom: 35px;">
                ...
                <div class="col-xl-5 col-md-6">
                    <button type="button" class="float-right ml-8" onclick="tambahKelas()"> Tambah Kelas </button>
                </div>
            </div>
            ...
            <table style="padding-top: 35px;" class="table table-light">
                ...
                <?php
                $query = mysqli_query($koneksi, "select * from master_kelas");
                $nomor = 1;
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="form_edit_kelas.php?k_kelas=<?php echo $data['kode_kelas']; ?>">
                                    <input type="button" class="btn btn-success" value="Edit">
                                </a>
                                <a href="delete_kelas.php?k_kelas=<?php echo $data['kode_kelas']; ?>">
